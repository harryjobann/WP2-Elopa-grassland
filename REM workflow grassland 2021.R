...
# # exifdat
exifdat_test_05 <- read.csv('https://raw.githubusercontent.com/harryjobann/WP2-Elopa-grassland/refs/heads/main/2021_grassland_exifdat.csv', 
                             header = TRUE, colClasses = 'character')

# # depdat
deptab_test_05 <- read.csv('https://raw.githubusercontent.com/harryjobann/WP2-Elopa-grassland/refs/heads/main/2021_grassland_deptab.csv', header = TRUE)

# posdat
posdat_dibang <- read.csv(file = 'https://raw.githubusercontent.com/harryjobann/WP2-Elopa-grassland/refs/heads/main/2021_grassland_posdat.csv', header = TRUE)
