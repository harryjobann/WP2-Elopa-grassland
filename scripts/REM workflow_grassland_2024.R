...
# tagging data
exifdat_test_05 <- read.csv('https://raw.githubusercontent.com/harryjobann/WP2-Elopa-grassland/refs/heads/main/data/exifdat_test_05.csv', 
                           header = TRUE, colClasses = 'character')
# deployments
deptab_test_05 <- read.csv('https://raw.githubusercontent.com/harryjobann/WP2-Elopa-grassland/refs/heads/main/data/deptab_test_05.csv', header = TRUE)

# animal position data
posdat_dibang <- read.csv('https://raw.githubusercontent.com/harryjobann/WP2-Elopa-grassland/refs/heads/main/data/posdat_dibang.csv', header = TRUE)
